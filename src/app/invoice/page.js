  ...
  return (
    <div className="min-h-screen bg-slate-200 p-4 md:p-8 font-sans">
      <div className="max-w-4xl mx-auto mb-6 flex justify-between items-center print:hidden">
        ...
        <button onClick={handlePrint} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-bold shadow-lg flex items-center gap-2">
...
// ВОТ ТА САМАЯ ОБЕРТКА SUSPENSE, КОТОРУЮ ТРЕБОВАЛ VERCEL

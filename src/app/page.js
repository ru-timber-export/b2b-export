    ...
    <div className="min-h-screen bg-stone-50 text-stone-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="relative w-11 h-11 bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-lg flex items-center justify-center shadow-lg border border-amber-500/40">
              <span className="font-black text-2xl text-amber-400">R</span>
            ...
            <div className="flex flex-col">
              <span className="font-black text-xl tracking-widest text-white">RU-TIMBER</span>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 text-white px-5 py-2.5 rounded font-bold text-sm flex items-center gap-2 transition-all shadow-lg border border-amber-500/30"
            >
      ...
      <header className="relative bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 text-white overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-emerald-700/30 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-24 md:py-36 relative z-10">
          <div className="mb-6 text-amber-400/80 text-2xl md:text-3xl" dir="rtl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://wa.me/79153490007" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-emerald-950 px-8 py-4 rounded-sm font-bold text-lg text-center transition-all shadow-2xl tracking-wide">
              REQUEST A QUOTATION
            </a>
            <a href="#products" className="bg-emerald-900/60 hover:bg-emerald-900 border border-amber-500/40 text-white px-8 py-4 rounded-sm font-bold text-lg text-center transition-all tracking-wide backdrop-blur-sm">
              VIEW PRODUCTS
            </a>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4">
        ...
        <div id="products" className="grid grid-cols-1 md:grid-cols-3 gap-6 -mt-16 mb-24 relative z-20">
          <div className="bg-white p-8 rounded-sm shadow-xl border-t-4 border-amber-500 hover:shadow-2xl transition-shadow">
            ...
            <h3 className="text-xl font-bold mb-3 text-emerald-950">GOST 8486-86 Standard</h3>
          ...
          <div className="bg-white p-8 rounded-sm shadow-xl border-t-4 border-emerald-700 hover:shadow-2xl transition-shadow">
            ...
            <h3 className="text-xl font-bold mb-3 text-emerald-950">Kiln Dried 10-12%</h3>
          ...
          <div className="bg-white p-8 rounded-sm shadow-xl border-t-4 border-amber-500 hover:shadow-2xl transition-shadow">
            ...
            <h3 className="text-xl font-bold mb-3 text-emerald-950">ISPM-15 & Full Docs</h3>
        ...
        <section id="why" className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-emerald-950 mb-4">Why Russian Halal Timber</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div className="bg-gradient-to-br from-emerald-950 to-emerald-900 text-white p-6 rounded-sm border border-amber-500/30 hover:border-amber-500 transition-colors">
              <div className="text-4xl mb-3">🌲</div>
              <h3 className="font-bold text-amber-400 mb-2 tracking-wider text-sm">SLOW-GROWN</h3>
              <p className="text-stone-300 text-xs leading-relaxed">Northern European Russia. 2-4mm annual rings. Slow growth means density.</p>
            </div>
            <div className="bg-gradient-to-br from-emerald-950 to-emerald-900 text-white p-6 rounded-sm border border-amber-500/30 hover:border-amber-500 transition-colors">
              <div className="text-4xl mb-3">❄️</div>
              <h3 className="font-bold text-amber-400 mb-2 tracking-wider text-sm">COLD CLIMATE</h3>
              <p className="text-stone-300 text-xs leading-relaxed">Vologda forests. 2x stronger than tropical timber. Naturally durable.</p>
            </div>
            <div className="bg-gradient-to-br from-emerald-950 to-emerald-900 text-white p-6 rounded-sm border border-amber-500/30 hover:border-amber-500 transition-colors">
              <div className="text-4xl mb-3">📜</div>
              <h3 className="font-bold text-amber-400 mb-2 tracking-wider text-sm">GOST QUALITY</h3>
              <p className="text-stone-300 text-xs leading-relaxed">State Standard 8486-86. Grade 1-3 export selection. Guaranteed.</p>
            </div>
            <div className="bg-gradient-to-br from-emerald-950 to-emerald-900 text-white p-6 rounded-sm border border-amber-500/30 hover:border-amber-500 transition-colors">
              <div className="text-4xl mb-3">🌙</div>
              <h3 className="font-bold text-amber-400 mb-2 tracking-wider text-sm">HALAL SOURCED</h3>
              <p className="text-stone-300 text-xs leading-relaxed">LesEGAIS verified. Ethical, transparent supply chain. Pure REDWOOD.</p>
            </div>
            <div className="bg-gradient-to-br from-emerald-950 to-emerald-900 text-white p-6 rounded-sm border border-amber-500/30 hover:border-amber-500 transition-colors">
              <div className="text-4xl mb-3">🚢</div>
              <h3 className="font-bold text-amber-400 mb-2 tracking-wider text-sm">DIRECT EXPORT</h3>
              <p className="text-stone-300 text-xs leading-relaxed">Novorossiysk and St. Petersburg ports. To Jebel Ali in 21 days.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-emerald-950 mb-4">Sawn Timber Catalog</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-sm overflow-hidden shadow-xl border border-stone-200 hover:shadow-2xl transition-shadow">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="text-2xl font-bold text-emerald-950">Pine</h3>
            ...
            <div className="bg-white rounded-sm overflow-hidden shadow-xl border border-stone-200 hover:shadow-2xl transition-shadow">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="text-2xl font-bold text-emerald-950">Spruce</h3>
            ...
            <div className="bg-white rounded-sm overflow-hidden shadow-xl border border-stone-200 hover:shadow-2xl transition-shadow">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="text-2xl font-bold text-emerald-950">Larch</h3>
          ...
          <div className="mt-8 bg-emerald-950 text-white rounded-sm p-8 border border-amber-500/30">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                ...
                <div className="text-xl font-bold text-amber-400">22 · 25 · 32 · 44 · 50</div>
              </div>
              <div>
                <div className="text-xs text-stone-400 mb-2 tracking-wider">WIDTH</div>
                <div className="text-xl font-bold text-amber-400">100 · 150 · 200</div>
              </div>
              <div>
                <div className="text-xs text-stone-400 mb-2 tracking-wider">LENGTH</div>
                <div className="text-xl font-bold text-amber-400">3000 — 6000</div>
              </div>
              <div>
                <div className="text-xs text-stone-400 mb-2 tracking-wider">CONTAINER</div>
                <div className="text-xl font-bold text-amber-400">40HC · ~62 m³</div>
              </div>
            </div>
        ...
        <section id="logistics" className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-emerald-950 mb-4">From Forest to Your Port</h2>
          ...
          <div className="bg-white rounded-sm shadow-xl p-10 border border-stone-200">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              ...
              <div className="text-center relative bg-white">
                <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4 border-2 shadow-lg bg-amber-50 border-amber-500 text-amber-700">
                  <span className="font-black text-lg">01</span>
                </div>
                <h4 className="font-bold text-emerald-950 mb-2 tracking-wider uppercase text-sm">Sourcing</h4>
                <p className="text-xs text-stone-600 leading-relaxed">Direct from our Vologda sawmills. LesEGAIS verified. KD chamber drying.</p>
              </div>

              <div className="text-center relative bg-white">
                <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4 border-2 shadow-lg bg-emerald-50 border-emerald-700 text-emerald-700">
                  <span className="font-black text-lg">02</span>
                </div>
                <h4 className="font-bold text-emerald-950 mb-2 tracking-wider uppercase text-sm">Transport</h4>
                <p className="text-xs text-stone-600 leading-relaxed">Truck or rail to Novorossiysk or St. Petersburg port. 5-7 days.</p>
              </div>
              ...
              <div className="text-center relative bg-white">
                ...
                <h4 className="font-bold text-emerald-950 mb-2 tracking-wider uppercase text-sm">Export</h4>
                <p className="text-xs text-stone-600 leading-relaxed">Phytosanitary, Origin Form A/CT-1, ISPM-15, Telex B/L.</p>
              </div>
              ...
              <div className="text-center relative bg-white">
                ...
                <h4 className="font-bold text-emerald-950 mb-2 tracking-wider uppercase text-sm">Delivery</h4>
                <p className="text-xs text-stone-600 leading-relaxed">Ocean freight to Jebel Ali, Dammam, Doha, Alexandria. FOB/CIF.</p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-24">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-emerald-950 mb-4">Quality Certificates</h2>
            <p className="text-stone-600 max-w-2xl mx-auto">Every shipment is fully documented and verified at every stage.</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-sm border-t-4 border-amber-500 text-center shadow-md">
              ...
              <div className="font-bold text-emerald-950 text-sm mb-1">GOST 8486-86</div>
              <div className="text-xs text-stone-500">Russian State Standard</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-sm border-t-4 border-amber-500 text-center shadow-md">
              ...
              <div className="font-bold text-emerald-950 text-sm mb-1">Phytosanitary</div>
              <div className="text-xs text-stone-500">Rosselkhoznadzor</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-sm border-t-4 border-amber-500 text-center shadow-md">
              ...
              <div className="font-bold text-emerald-950 text-sm mb-1">ISPM-15</div>
              <div className="text-xs text-stone-500">IPPC stamped</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-sm border-t-4 border-amber-500 text-center shadow-md">
              ...
              <div className="font-bold text-emerald-950 text-sm mb-1">Origin</div>
              <div className="text-xs text-stone-500">Form A / CT-1</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-stone-50 p-6 rounded-sm border-t-4 border-amber-500 text-center shadow-md">
              ...
              <div className="font-bold text-emerald-950 text-sm mb-1">LesEGAIS</div>
              <div className="text-xs text-stone-500">Halal sourcing</div>
            </div>
          </div>
        </section>
      ...
      <footer id="contact" className="bg-emerald-950 text-stone-400 pt-16 pb-8 border-t-2 border-amber-500/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <div className="text-amber-400 text-2xl mb-3" dir="rtl">الحمد لله</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 border-y border-emerald-800 py-10">
            <div>
              ...
              <a href="https://wa.me/79153490007" className="text-white hover:text-amber-400 transition-colors text-lg font-semibold">+7 915 349 00 07</a>
            ...
            <div>
              ...
              <a href="mailto:ksemakin@icloud.com" className="text-white hover:text-amber-400 transition-colors break-all">ksemakin@icloud.com</a>
      ...
      {/* WHATSAPP FLOAT */}
      <a href="https://wa.me/79153490007" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 bg-gradient-to-br from-emerald-600 to-emerald-700 text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all z-50 flex items-center justify-center border-2 border-amber-500/50">
